        ...
        <div className="grid grid-cols-1">
          <div className="bg-white dark:bg-slate-900 rounded-md shadow-md dark:shadow-gray-800">
            <form action="#">
              ...
              <div className="grid grid-cols-4 lg:grid-cols-4 md:grid-cols-2 md:grid-rows-2 sm:grid-cols-1 sm2:grid-cols-1">
                <div className="bg-gray-100 p-4"><input type="text" placeholder="Type here" className="input w-full " /></div>
                <div className="bg-gray-200 p-4"><input type="text" placeholder="Type here" className="input w-full " /></div>
                <div className="bg-gray-300 p-4"><input type="text" placeholder="Type here" className="input w-full " /></div>
                <div className="bg-gray-400 p-4"><input type="text" placeholder="Type here" className="input w-full " /></div>
              </div>
