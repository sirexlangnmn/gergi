...
import { bgOptometry } from '../assets'

const Hero1 = () => {
  return (
    <>
      {/* <section className="relative table w-full py-32 lg:py-36 bg-[url('../../assets/images/real/bg/01.jpg')] bg-no-repeat bg-center"> */}
      <section className="relative table w-full py-32 lg:py-36" style={{ backgroundImage: `url(${bgOptometry})`, backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
